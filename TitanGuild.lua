...
-- Not sure what you were trying to do here but I could not find MAX_PLAYER_LEVEL_TABLE to pull value from and shadowlands did a level squash
-- new max is now going to be 60
-- TITAN_GUILD_LEVEL_MAX_CAP = MAX_PLAYER_LEVEL_TABLE[GetMaximumExpansionLevel()];
TITAN_GUILD_LEVEL_MAX_CAP = 60;
...
----------------------------------------------------------------------
--  TitanPanelGuildButton_AddClassFilter(className)
----------------------------------------------------------------------
